...
fn make_move_works() {
	new_test_ext().execute_with(|| {
		...
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "e2e4".into()));
		...
		// test MatchWon
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "e7e5".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "g1f3".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "b8c6".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "d2d4".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "e5d4".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "f3d4".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "f8c5".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "c2c3".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "d8f6".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "d4c6".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "f6f2".into()));
		...
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "c2c4".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "h7h5".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "h2h4".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "a7a5".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "d1a4".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "a8a6".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "a4a5".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "a6h6".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "a5c7".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "f7f6".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "c7d7".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "e8f7".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "d7b7".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "d8d3".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "b7b8".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "d3h7".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "b8c8".into()));
		assert_ok!(Chess::make_move(Origin::signed(bob), match_id, "f7g6".into()));
		assert_ok!(Chess::make_move(Origin::signed(alice), match_id, "c8e6".into()));
		System::assert_has_event(
			Event::MatchDrawn {
				0: match_id,
...
fn claim_victory_works() {
	new_test_ext().execute_with(|| {
		...
		assert_ok!(Chess::clear_abandoned_match(Origin::signed(alice), match_id));
...
fn janitor_incentive_works() {
	new_test_ext().execute_with(|| {
		...
		assert_ok!(Chess::clear_abandoned_match(Origin::signed(charlie), match_id));
